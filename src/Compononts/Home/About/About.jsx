...
//       <div className="  ">
//         <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-2 justify-center items-center px-3 lg:px-28">
//           <div className=" md:w-[37rem]  rounded-2xl bg-black text-white shadow-inner border border-slate-700 shadow-slate-700 px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
...
//           {/* Right: Image */}
//           <div className=" h-[90vh] md:w-[40rem] object- rounded-2xl overflow-hidden shadow-inner border border-slate-700 shadow-slate-700 bg-black">
//             <img
//               src="About/IMG_2106.JPG"
//               alt="Raheb portrait"
